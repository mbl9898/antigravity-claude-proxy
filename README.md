...
>
> **Claude Code v2.1.274+ Compatibility**: The proxy automatically strips Anthropic billing headers (`x-anthropic-billing-header`) and neutralizes proprietary identity strings from system prompts, preventing false `429 RESOURCE_EXHAUSTED` errors. See [Claude Code Compatibility](docs/claude-code-compatibility.md).
